...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/mnt/tier2/project/p201392/u103958/zod_moe/zod_nuscenes/infos/zod_nuscenes_infos_lighting_test_twilight.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        data_prefix=dict(pts=''),
        data_root='/mnt/tier2/project/p201392/u103958/zod_moe/zod_nuscenes/',
...
work_dir = '/mnt/tier2/users/u103958/projects/multimodal-MoE/outputs/runs/zod_lidar_only/eval/raw/lighting_test_twilight'
