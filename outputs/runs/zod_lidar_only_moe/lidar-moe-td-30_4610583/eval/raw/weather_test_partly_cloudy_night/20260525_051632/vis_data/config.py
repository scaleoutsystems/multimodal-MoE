...
launcher = 'none'
load_from = 'outputs/runs/zod_lidar_only_moe/lidar-moe-td-30_4610583/best_mAP_0.50_epoch_30.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/mnt/tier2/project/p201392/u103958/zod_moe/zod_nuscenes/infos/zod_nuscenes_infos_weather_test_partly_cloudy_night.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        data_prefix=dict(pts=''),
        data_root='/mnt/tier2/project/p201392/u103958/zod_moe/zod_nuscenes/',
...
work_dir = 'outputs/runs/zod_lidar_only_moe/lidar-moe-td-30_4610583/eval/raw/weather_test_partly_cloudy_night'
