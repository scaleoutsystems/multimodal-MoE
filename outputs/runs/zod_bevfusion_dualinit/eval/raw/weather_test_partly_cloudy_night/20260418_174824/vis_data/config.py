...
custom_hooks = [
    dict(
        camera_ckpt=
        '/home/users/u103958/projects/multimodal-MoE/outputs/runs/zod_camera_only/zod-cam-only_4469392/best_mAP_0.50_epoch_11.pth',
        camera_modules=[
            'img_backbone',
            'img_neck',
            'view_transform',
        ...
        lidar_ckpt=
        '/home/users/u103958/projects/multimodal-MoE/outputs/runs/zod_lidar_only/zod-lidar-only_4454825/best_mAP_0.50_epoch_18.pth',
        lidar_modules=[
            'pts_middle_encoder',
            'pts_backbone',
            'pts_neck',
    ...
    dict(
        type='BEVFeatureVisualizationHook', vis_epochs=(
            1,
            3,
            5,
            7,
...
launcher = 'none'
load_from = 'outputs/runs/zod_bevfusion_dualinit/bevfusion-dualinit_4481497/best_mAP_0.50_epoch_12.pth'
log_level = 'INFO'
...
work_dir = '/mnt/tier2/users/u103958/projects/multimodal-MoE/outputs/runs/zod_bevfusion_dualinit/eval/raw/weather_test_partly_cloudy_night'
